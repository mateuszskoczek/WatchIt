...
namespace WatchIt.Database.Migrations
{
    ...
    [Migration("20240603125708_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WatchIt.Database.Model.Account.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LeftSalt = "Y&%]J>6Nc3&5~UUXnNxq",
                            Password = new byte[] { 68, 170, 8, 113, 134, 47, 98, 43, 96, 183, 126, 130, 204, 45, 4, 113, 81, 200, 244, 26, 54, 88, 161, 246, 84, 93, 159, 219, 12, 143, 128, 160, 198, 194, 47, 133, 216, 242, 158, 184, 43, 38, 134, 132, 175, 179, 42, 40, 0, 143, 111, 252, 156, 215, 17, 185, 12, 109, 119, 214, 211, 167, 32, 121 },
                            RightSalt = "MV1jo~o3Oa^;NWb\\Q)t_",
                            Username = "root"
                        });
                });
            ...
            modelBuilder.Entity("WatchIt.Database.Model.Media.MediaPhotoImage", b =>
                {
                    ...
                    b.Property<Guid?>("MediaPhotoImageBackgroundId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("MediaPhotoImageBackgroundId");
            ...
            modelBuilder.Entity("WatchIt.Database.Model.Media.MediaPhotoImage", b =>
                {
                    b.HasOne("WatchIt.Database.Model.Media.MediaPhotoImageBackground", null)
                        .WithOne("MediaPhotoImage")
                        .HasForeignKey("WatchIt.Database.Model.Media.MediaPhotoImage", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("WatchIt.Database.Model.Media.MediaPhotoImageBackground", "MediaPhotoImageBackground")
                        .WithMany()
                        .HasForeignKey("MediaPhotoImageBackgroundId");
